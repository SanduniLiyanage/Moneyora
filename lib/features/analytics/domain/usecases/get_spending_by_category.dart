...
/// What was spent per category over a period. FR-RPT-001, FR-RPT-003.
///
...
class GetSpendingByCategory implements UseCase<List<CategoryTotal>, DateRange> {
  ...
  @override
  Future<Either<Failure, List<CategoryTotal>>> call(DateRange params) async {
